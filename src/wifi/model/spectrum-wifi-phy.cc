...
SpectrumWifiPhy::GetTxPowerSpectralDensity (uint16_t centerFrequency, uint16_t channelWidth, double txPowerW, WifiModulationClass modulationClass) const
{
  ...
  Ptr<SpectrumValue> v;
  std::cout << "11p Modulation class: " << modulationClass << std::endl;
  std::cout << "11p channelWidth: " << channelWidth << std::endl;
  std::cout << "11p txPowerW: " << txPowerW << std::endl;
  std::cout << "11p center frequency: " << centerFrequency << std::endl;
