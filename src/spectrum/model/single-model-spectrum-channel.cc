  ...
  static TypeId tid = TypeId ("ns3::SingleModelSpectrumChannel")
    ...
    .AddTraceSource ("PathLoss",
      ...
      .AddAttribute("UseGSCM",
                    ...
                    BooleanValue(false),
                    MakeBooleanAccessor(&SingleModelSpectrumChannel::m_useGSCM),
                    MakeBooleanChecker())
  ;
  return tid;
}
                  ...
                  if (m_useGSCM)
                    {
                      ...
                      std::cout<< "m_useGSCM value is " << m_useGSCM << "Single model" << " GSCM power received: " << propagationGainDb << std::endl;
