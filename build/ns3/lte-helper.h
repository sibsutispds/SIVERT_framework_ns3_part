...
public:
  ...
  */
  ...
  /**
   * \return a pointer to the PropagatioLossModel instance used for the downlink
   */
  Ptr<PropagationLossModel> GetDownlinkPropagationLossModel (void) const;

  /**
   * \return a pointer to the PropagatioLossModel instance used for the uplink
   */
  Ptr<PropagationLossModel> GetUplinkPropagationLossModel (void) const;
...
private:
  ...
  /**
   * Indicator if GSCM from Unity3D is enabled
   */
  bool m_useGSCM = false;
